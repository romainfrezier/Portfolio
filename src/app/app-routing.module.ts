...
const routes: Routes = [
  ...
  { path: AppConstants.ROUTES.PROJECTS, loadChildren: () => import('./pages/projects/projects.module').then(m => m.ProjectsModule) },
  ...
  { path: AppConstants.ROUTES.HOME, loadChildren: () => import('./pages/home/home.module').then(m => m.HomeModule), pathMatch: 'full' },

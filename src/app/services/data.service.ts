...
export class DataService {
  ...
  public getSchoolProjects(lang: string): Observable<SchoolProject[]> {
    return this.http.get<SchoolProject[]>(`./assets/data/${lang}/school-projects.json`)
  }

  public getPersonalProjects(lang: string): Observable<PersonalProject[]> {
    return this.http.get<PersonalProject[]>(`./assets/data/${lang}/personal-projects.json`)
  }

  public getWorkExperiences(lang: string): Observable<WorkExperience[]> {
    return this.http.get<WorkExperience[]>(`./assets/data/${lang}/work-experiences.json`)
  }
  ...
  public getArchivedProjects(lang: string): Observable<SchoolProject[]> {
    return this.http.get<SchoolProject[]>(`./assets/data/${lang}/archived-school-projects.json`)
  }
